        ...
        if matchType == "One-Day" or matchType == "Twenty20":
            ...
            if team2Name != "" and len(team2ScoreDetails) != 0:
                ...
                if team2Name in teamImpliedOdds and matchOddsAdj is not None:
                    ...
                    with open('scoresPricesOdds.csv', 'ab') as csvfile:
                ...
                if matchType == "Twenty20":
                    ballsRem = 120 - team2Overs * 6
                    if team1Runs == 0:
                        c.execute('select avg(result), t20Id, runs, wkts, overs from overComparisonODI where t20Id>=600 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runs<=1 and wkts>='+`(team1Wkts-1)`+' and wkts<='+`(team1Wkts+1)` + ' group by t20Id ')
                    else:
                        c.execute('select avg(result), t20Id, runs, wkts, overs  from overComparisonODI where t20Id>=600 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runRate<='+`(runRate*1.1)`+' and runRate>'+`(runRate*0.9)`+' and wkts='+`team1Wkts` + ' group by t20Id union '\
                        'select avg(result), t20Id, runs, wkts, overs from overComparisonODI where t20Id>=600 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runRate<='+`(runRate*1.05)`+' and runRate>'+`(runRate*0.85)`+' and wkts='+`(team1Wkts+1)` + ' group by t20Id union '\
                        'select avg(result), t20Id, runs, wkts, overs from overComparisonODI where t20Id>=600 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runRate<='+`(runRate*1.15)`+' and runRate>'+`(runRate*0.95)`+' and wkts='+`(team1Wkts-1)` + ' group by t20Id')
                else:
                    ballsRem = 300 - team2Overs * 6
                    if team1Runs == 0:
                        c.execute('select avg(result), odiId, runs, wkts, overs from overComparisonODI where odiId>=3000 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runs<=1 and wkts>='+`(team1Wkts-1)`+' and wkts<='+`(team1Wkts+1)` + ' group by odiId ')
                    else:
                        ...
                        'select avg(result), odiId, runs, wkts, overs from overComparisonODI where odiId>=3000 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runRate<='+`(runRate*1.05)`+' and runRate>'+`(runRate*0.85)`+' and wkts='+`(team1Wkts+1)` + ' group by odiId union '\
                        'select avg(result), odiId, runs, wkts, overs from overComparisonODI where odiId>=3000 and innings=1 and overs>='+`(team1Overs-1)`+' and overs<'+`(team1Overs+1)`+' and runRate<='+`(runRate*1.15)`+' and runRate>'+`(runRate*0.95)`+' and wkts='+`(team1Wkts-1)` + ' group by odiId')
