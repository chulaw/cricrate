...
sessionToken = 'G2QJN7MxDcFMjsXbC8M+zvwtmldbDQS6qmNmlD/qUkY='
...
horseRacingEventTypeID = getEventTypeIDForHorseRacing(eventTypesResult, 'Cricket')

print 'Eventype Id for Cricket is :' + str(horseRacingEventTypeID)
