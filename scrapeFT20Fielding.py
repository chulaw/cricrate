...
#startFT20 = 0 if startFT20 == 0 else startFT20
...
# get ft20s info
c.execute('select ft20Id, startDate, scoreLink from ft20Info')
...
for x in range(startFT20, len(ft20sInfo)):
    ...
    c.execute('select player, playerId from battingFT20Innings where ft20Id=? and innings=1',(ft20Id,))
    batsmen1 = c.fetchall()
    batsmen1Names = []
    batsman2Id1 = {}
    ...
    c.execute('select player, playerId from battingFT20Innings where ft20Id=? and innings=2',(ft20Id,))
    batsmen2 = c.fetchall()
    batsmen2Names = []
    batsman2Id2 = {}
    ...
    for inn in range(1, 3):
        fieldingURL = 'http://www.espncricinfo.com' + ft20sInfo[x][2] + '?innings=' + `inn` + ';view=commentary'
        print fieldingURL
        ...
        for i in range(len(commentaryEvent)):
            ...
            if len(eventSplit) == 4:
                ...
                if inn == 1:
                    ...
                    if bowler == "Ahmed" and (ft20Id == 155 or ft20Id == 199 or ft20Id == 203 or ft20Id == 248 or ft20Id == 251 or ft20Id == 284 or ft20Id == 452 or ft20Id == 571 or ft20Id == 578 or ft20Id == 659 or ft20Id == 670):
                        eventBowler = "Abu Nechim"
                        bowler2Id1[eventBowler] = 456863

                    if batsman == "Matthew" and (ft20Id == 596 or ft20Id == 604 or ft20Id == 608 or ft20Id == 615):
                        eventBatsman = "Mervin Mathew"
                        batsman2Id1[eventBatsman] = 105245

                    if bowler == "Matthew" and (ft20Id == 599 or ft20Id == 610 or ft20Id == 613):
                        eventBowler = "Mervin Mathew"
                        bowler2Id1[eventBowler] = 105245

                    if batsman == "Scantlebury-Searles" and (ft20Id == 602 or ft20Id == 614 or ft20Id == 737 or ft20Id == 744 or ft20Id == 849):
                        eventBatsman = "Javon Searles"
                        batsman2Id1[eventBatsman] = 461111

                    if bowler == "Scantlebury-Searles" and (ft20Id == 604 or ft20Id == 612 or ft20Id == 728 or ft20Id == 732 or ft20Id == 734 or ft20Id == 849):
                        eventBowler = "Javon Searles"
                        bowler2Id1[eventBowler] = 461111

                    if batsman == "Ahmed" and ft20Id == 662:
                    ...
                    c.execute('insert or ignore into commentaryEventFT20 (eventId, ft20Id, bowler, batsman, bowlerId, batsmanId, commentary) values (?, ?, ?, ?, ?, ?, ?)',
                          (eventId, ft20Id, eventBowler, eventBatsman, bowler2Id1[eventBowler], batsman2Id1[eventBatsman], commentary))
                else:
                    ...
                    if batsman == "Ahmed" and (ft20Id == 155 or ft20Id == 199 or ft20Id == 251 or ft20Id == 571 or ft20Id == 659 or ft20Id == 670):
                        eventBatsman = "Abu Nechim"
                        batsman2Id2[eventBatsman] = 456863

                    if bowler == "Ahmed" and (ft20Id == 203 or ft20Id == 205 or ft20Id == 218 or ft20Id == 447 or ft20Id == 567 or ft20Id == 575 or ft20Id == 662):
                        eventBowler = "Abu Nechim"
                        bowler2Id2[eventBowler] = 456863

                    if bowler == "Matthew" and (ft20Id == 592 or ft20Id == 596 or ft20Id == 604 or ft20Id == 608 or ft20Id == 615):
                        eventBowler = "Mervin Mathew"
                        bowler2Id2[eventBowler] = 105245

                    if bowler == "Scantlebury-Searles" and (ft20Id == 602 or ft20Id == 737 or ft20Id == 744 or ft20Id == 849):
                        eventBowler = "Javon Searles"
                        bowler2Id2[eventBowler] = 461111

                    if batsman == "Scantlebury-Searles" and (ft20Id == 612 or ft20Id == 728 or ft20Id == 732 or ft20Id == 734 or ft20Id == 849):
                        eventBatsman = "Javon Searles"
                        batsman2Id2[eventBatsman] = 461111
                    ...
                    # print "bowler: " + eventBowler
                    c.execute('insert or ignore into commentaryEventFT20 (eventId, ft20Id, bowler, batsman, bowlerId, batsmanId, commentary) values (?, ?, ?, ?, ?, ?, ?)',
                          (eventId, ft20Id, eventBowler, eventBatsman, bowler2Id2[eventBowler], batsman2Id2[eventBatsman], commentary))
                ...
                if (" c " in eventText or " st" in eventText) and "SR:" in eventText:
                    ...
                    if inn == 1:
                        ...
                        if eventBatsman in batsman2Id1:
                            c.execute('select rating from battingFT20Live where playerId=? and ft20Id<? order by ft20Id desc', (batsman2Id1[eventBatsman], ft20Id))
                    ...
                    if eventBowler == "":
                        ...
                        if eventBatsman in batsman2Id2:
                            c.execute('select rating from battingFT20Live where playerId=? and ft20Id<? order by ft20Id desc', (batsman2Id2[eventBatsman], ft20Id))
                            battingLiveRating = c.fetchone()
                        if eventBowler == "":
                            for bowler in bowler2Names:
                                bowlerSplit = bowler.split(" ")
            ...
            if eventFound == 0 and eventId != "" and fielder != "" and fielder != eventBatsman and (droppedCatch == 1 or misfield == 1 or missedStumping == 1 or greatCatch == 1 or directHit == 1 or greatSave == 1 or catch == 1 or stumping == 1):
                ...
                if inn == 1:
                    c.execute('insert or ignore into fieldingEventFT20 (eventId, ft20Id, bowler, batsman, bowlerId, batsmanId, fielder, fielderId, catch, droppedCatch, misfield, stumping, missedStumping,'
                              'greatCatch, directHit, greatFielding, runsSaved, commentary) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                            (eventId, ft20Id, eventBowler, eventBatsman, bowler2Id1[eventBowler], batsman2Id1[eventBatsman], fielder, fielderId, catch, droppedCatch, misfield, stumping, missedStumping,
                             greatCatch, directHit, greatSave, runsSaved, commentary))
                else:
                    c.execute('insert or ignore into fieldingEventFT20 (eventId, ft20Id, bowler, batsman, bowlerId, batsmanId, fielder, fielderId, catch, droppedCatch, misfield, stumping, missedStumping,'
                              'greatCatch, directHit, greatFielding, runsSaved, commentary) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                            (eventId, ft20Id, eventBowler, eventBatsman, bowler2Id2[eventBowler], batsman2Id2[eventBatsman], fielder, fielderId, catch, droppedCatch, misfield, stumping, missedStumping,
                             greatCatch, directHit, greatSave, runsSaved, commentary))
    ...
    for fielderId in fielderCatches.keys():
        ...
        matchId = repr(int(ft20Id)) + repr(fielderId)
        c.execute('insert or ignore into fieldingFT20Match (matchId, playerId, player, ft20Id, keeper, catches, droppedCatches, misfields, stumpings, missedStumpings, greatCatches, directHits, greatSaves, runsSaved, '
                  'rating) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                 (matchId, fielderId, fielderName[fielderId], ft20Id, (1 if fielderId in keeper else 0), fielderCatches[fielderId], fielderDroppedCatches[fielderId], fielderMisfield[fielderId], fielderStumpings[fielderId], fielderMissedStumping[fielderId],
                  fielderGreatCatch[fielderId], fielderDirectHit[fielderId], fielderGreatSave[fielderId], fielderRunsSaved[fielderId], rating))

        c.execute('select matchId, rating from fieldingFT20Live where playerId=? order by matchId desc', (fielderId, ))
        ...
        c.execute('insert or ignore into fieldingFT20Live(matchId, startDate, playerId, ft20Id, player, rating) values (?, ?, ?, ?, ?, ?)',
                    (matchId, startDate, fielderId, ft20Id, fielderName[fielderId], liveRating))
