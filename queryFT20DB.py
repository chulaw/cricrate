...
for row in c.execute('delete FROM battingFT20Innings where ft20Id>842'):
        print row
for row in c.execute('delete FROM bowlingFT20Innings where ft20Id>842'):
        print row
for row in c.execute('delete FROM allRoundFT20Match where ft20Id>842'):
     print row
for row in c.execute('delete FROM battingFT20Live where ft20Id>842'):
     print row
for row in c.execute('delete FROM bowlingFT20Live where ft20Id>842'):
     print row
for row in c.execute('delete FROM allRoundFT20Live where ft20Id>842'):
     print row
