...
if ($matchFormat == "FT20") {
    ...
    echo "<li>Match results are used to generate team ratings. Fielding performances are evaluated by parsing detailed text commentary (More detail <a href=\"blog.php?title=fielding\">here</a>). Win shares are calculated by attributing over-by-over team match odds changes to the appropriate player.</li><br/>";
} else {
    echo "<br/><ul>";
    ...
    echo "<li>Match results are used to generate team ratings. Peak ratings are identified by checking if the rating before and after the particular match considered is lower.</li><br/>";
    echo "<li>Fielding performances are evaluated by parsing detailed text commentary. More detail <a href=\"blog.php?title=fielding\">here</a>.</li><br/>";
    echo "<li>Win shares are calculated by attributing over-by-over team match odds changes to the appropriate player.</li><br/>";
    echo "<li>Players lose 1% of their live rating if they miss a team match. This is to ensure injured or dropped players do not stay high in the ratings without playing matches.</li><br/>";
}
echo "</ul>";
echo "</li>";
echo "<li class=\"list-group-item\">";
...
if ($matchFormat == "Test") {
	...
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Batting Careers</b></a>:<br/> This evaluates overall careers by calculating the average performance rating of each batsman, with a bonus given to career longevity (where playing the most number of years while missing the least percentage of matches gets the most credit) and a penalty for careers of less than 40 matches (increasing penalty for lower matches played). The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Batting Performances</b></a>:<br/> This is a list of the highest rated batting performances calculated using the factors detailed here.</li><br/>";
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team Batting Peaks</b></a>:<br/> This lists the best batting line-ups by aggregate current batting ratings of the players that batted for the team in a match. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
	...
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Bowling Performances</b></a>:<br/> This is a list of the highest rated bowling performances calculated using the factors given below.</li><br/>";
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team Bowling Peaks</b></a>:<br/> This lists the best bowling attacks by aggregate current bowling ratings of the first 5 players that bowled for the team in a match. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
	...
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat All-Round Careers</b></a>:<br/> This evaluates overall careers by calculating the average match all-round rating of each player, with a bonus given to career longevity (where playing the most number of years while missing the least percentage of matches gets the most credit) and a penalty for careers of less than 40 matches (increasing penalty for lower matches played). An additional bonus is added based on the player's batting average - bowling average ratio. The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat All-Round Performances</b></a>:<br/> This is a list of the highest rated all-round performances.</li><br/>";
	...
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best/Worst $matchFormat Fielding Performances</b></a>:<br/> This is a list of the highest and lowest rated fielding performances.</li><br/>";
    } else if ($disc == "Team") {
  echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current $matchFormat $disc Rankings</b></a>:<br/> This is evaluated using a weighted average of a team's match results. More weight is given to recent performances with past performances diminishing in value with time. A higher rated team loses more points for losing to a lower rated team, and vice versa. Away wins are given more credit (losses lower penalty) with home losses given higher penalty (wins lower credit). Each team starts at 350 points and moves higher on wins and lower on losses. Draws and ties will slightly reduce the higher rated team's rating while slightly increasing the lower team's rating.</li><br/>";
  ...
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team/Team Player Peaks</b></a>:<br/> This lists the best teams by team rating (Team) and aggregate current batting and bowling ratings (Player) that played for the team in a match. The aggregate bowling rating is adjusted by a factor of 1.5 to account for the importance of bowling in Tests and better line-up when aggregating with the batting ratings. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
    }
    echo "</ul><br/>";
    echo "</li></ul>";
    echo "</div>";
    ...
    echo "<br/><ul>";
    if ($disc == "Batting") {
	echo "<li><b>Runs scored</b>: This is the most significant factor. It values runs linearly upto 40, then each additional run becomes less valuable till 200, where the penalty is ever higher. These tiers were decided based on historical analysis of the correlation of runs scored and wins and draws. Scores in excess of 200 are pursued mainly as personal milestones and does not always line up with the team objective.</li><br/>";
  ...
  echo "<li><b>Pitch quality</b>: Moderate factor that considers total runs scored by the opposing team to quantify how easy or difficult run scoring is in the match. Adjustments are made for the innings number using historical average scores.</li><br/>";
  echo "<li><b>Support</b>: Compares the percentage of team runs made with the next highest player. Gives credit for making the team's highest score with little support from others in a completed team innings.</li><br/>";
  echo "<li><b>Partnership</b>: This factor rewards batsmen for being involved in big partnerships. The highest partnership the player was involved in is compared to the total match runs to evaluate its impact.</li><br/>";
  echo "<li><b>Strike rate</b>: Minor factor that adds a small bonus based on the strike rate of the innings weighted by the number of runs scored. For innings with no balls faced data, the minutes played percentage or the innings run rate is used to estimate the strike rate.</li><br/>";
	...
	echo "<li><b>Match status</b>: This factor rewards match-winning or match-savings innings made under pressure in the second innings. Significant contributions under pressure in successful fourth innings run chases and third innings come backs get the highest values.</li><br/>";
  echo "<li><b>Series status</b>: Minor factor that adds a bonus to innings in a series decider and a penalty to innings in dead rubbers.</li><br/>";
	...
	echo "<li><b>Wickets per run</b>: This is a major factor that gives the highest value to a high number of wickets taken with the least runs conceded. By tieing the factor with runs conceded this avoids rewarding wickets taken after conceding a significant number of runs.</li><br/>";
	echo "<li><b>Wickets per ball</b>: This is also a major factor that gives the highest value to a high number of wickets taken with the least number of balls bowled. This rewards strike bowlers that are very valuable in test matches.</li><br/>";
	echo "<li><b>Economy</b>: Minor factor that rewards bowling a long spell of tight bowling where only a few runs are scored. This is to distinguish between bowling innings where a bowler bowls well for long periods with no reward but keeps the pressure.</li><br/>";
	echo "<li><b>Wickets quality</b>: Major factor that considers the total current batting rating of the batsmen dismissed. The rating is adjusted to consider the runs scored by the batsman and the total runs conceded by the bowler to specifically reward the bowler for getting highly rated batsmen cheaply. Minimal credit is given when a batsman has already made the runs expected of him based on his rating.</li><br/>";
	echo "<li><b>Batting quality</b>: Moderate factor that considers the current rating of the batting line-up faced. Adds increasing value to more significant bowling performances to avoid rewarding unsuccessful and expensive returns against good batsmen.</li><br/>";
  echo "<li><b>Pitch quality</b>: Moderate factor that considers total runs scored by the opposing team to quantify how easy or difficult run scoring is in the match. Adjustments are made for the innings number using historical average scores.</li><br/>";
  echo "<li><b>Incomplete innings</b>: This factor comes into play significantly in incomplete innings (< 75 total overs bowled). If the bowler has bowled less that 15 overs and conceded less than 50 runs, it is deemed an incomplete performance where he did not get the opportunity to make an impact. In these cases, the bowler's current bowling rating overrides the innings performance to avoid unduely penalizing the performance. This functions similarly to a batsman being not out at the end of an innings.</li><br/>";
	echo "<li><b>Location</b>: This is a minor factor that adds a bonus to significant performances completed away from home.</li><br/>";
	echo "<li><b>Match status</b>: This factor rewards match-winning or match-savings performances made under pressure in the second innings. Significant contributions in successful fourth innings defenses and third innings come backs get the highest values.</li><br/>";
  echo "<li><b>Series status</b>: Minor factor that adds a bonus to bowling performances in a series decider and a penalty to performances in dead rubbers.</li><br/>";
	echo "<li><b>Result</b>: This factor recognizes significant contributions made in wins and draws. Positive results against higher rated teams are rewarded more than against lower rated teams, using the current rating at the time of the match of the opposition team.</li><br/>";
	echo "<li><b>Close match</b>: Rewards significant contributions made in close wins in terms of wickets or runs left. Recognizes performances that are remembered for delivering under pressure.</li><br/>";
	echo "<li><b>Milestone</b>: Minor factor that adds a bonus to bowling performances with at least 5 dismissals.</li><br/>";
    } else if ($disc == "All-Round") {
	...
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Batting Performances</b></a>:<br/> This is a list of the highest rated batting performances calculated using the factors detailed here.</li><br/>";
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team Batting Peaks</b></a>:<br/> This lists the best batting line-ups by aggregate current batting ratings of the first 8 players that batted for the team in a match. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
    } else if ($disc == "Bowling") {
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Top $matchFormat Bowlers</b></a>:<br/> This is evaluated using a weighted average of a bowler's performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished bowlers that have played less than 20 innings are penalized to avoid cases where a few highly rated innings can catapult a newer bowler to the top of the pile.</li><br/>";
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Bowling Careers</b></a>:<br/> This evaluates overall careers by calculating the average performance rating of each bowler, with a bonus given to career longevity (where playing the most number of years while missing the least percentage of matches gets the most credit) and a penalty for careers of less than 100 matches (increasing penalty for lower matches played). The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Bowling Performances</b></a>:<br/> This is a list of the highest rated bowling performances calculated using the factors given below.</li><br/>";
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team Bowling Peaks</b></a>:<br/> This lists the best bowling attacks by aggregate current bowling ratings of the first 6 players that bowled for the team in a match. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
    } else if ($disc == "All-Round") {
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Top $matchFormat All-Rounders</b></a>:<br/> This is evaluated using a weighted average of a player's all-round performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished players that have played less than 10 matches are penalized to avoid cases where a few highly rated matches can catapult a newer player to the top of the pile.</li><br/>";
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat All-Round Careers</b></a>:<br/> This evaluates overall careers by calculating the average match all-round rating of each player, with a bonus given to career longevity (where playing the most number of years while missing the least percentage of matches gets the most credit) and a penalty for careers of less than 100 matches (increasing penalty for lower matches played). An additional bonus is added based on the player's batting average - bowling average ratio. The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat All-Round Performances</b></a>:<br/> This is a list of the highest rated all-round performances.</li><br/>";
    } else if ($disc == "Fielding") {
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Best/Worst $matchFormat Fielders</b></a>:<br/> This is evaluated using a weighted average of a player's fielding performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished players that have played less than 10 matches are penalized to avoid cases where a few highly rated matches can catapult a newer player to the top of the pile.</li><br/>";
	...
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best/Worst $matchFormat Fielding Performances</b></a>:<br/> This is a list of the highest and lowest rated fielding performances.<br/></li>";
	...
	echo "<li><a href=\"performances.php?matchFormat=$matchFormat&disc=$disc\"><b>Best/Worst $matchFormat Win Share Performances</b></a>:<br/> This is a list of the highest and lowest rated win share match performances.</li><br/>";
    } else if ($disc == "Team") {
  ...
  echo "<li><a href=\"peaks.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Team/Team Player Peaks</b></a>:<br/> This lists the best teams by team rating (Team) and aggregate current batting and bowling ratings (Player) that played for the team in a match. Only peaks (aggregate rating before and after lower) are shown for clarity.</li><br/>";
    ...
    if ($disc == "Batting") {
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Top $matchFormat Batsmen</b></a>:<br/> This is evaluated using a weighted average of a batsman's performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished batsmen that have played less than 20 innings are penalized to avoid cases where a few highly rated innings can catapult a newer batsman to the top of the pile.</li><br/>";
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Batting Careers</b></a>:<br/> This evaluates overall careers by calculating the average performance rating of each batsman, with a bonus given to career longevity and a penalty for careers of less than 20 matches (increasing penalty for lower matches played). The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	...
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Top $matchFormat Bowlers</b></a>:<br/> This is evaluated using a weighted average of a bowler's performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished bowlers that have played less than 20 innings are penalized to avoid cases where a few highly rated innings can catapult a newer bowler to the top of the pile.</li><br/>";
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat Bowling Careers</b></a>:<br/> This evaluates overall careers by calculating the average performance rating of each bowler, with a bonus given to career longevity and a penalty for careers of less than 20 matches (increasing penalty for lower matches played). The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
	...
	echo "<li><a href=\"current.php?matchFormat=$matchFormat&disc=$disc\"><b>Current Top $matchFormat All-Rounders</b></a>:<br/> This is evaluated using a weighted average of a player's all-round performances. More weight is given to recent performances with past performances diminishing in value with time. Unestablished players that have played less than 10 matches are penalized to avoid cases where a few highly rated matches can catapult a newer player to the top of the pile.</li><br/>";
	echo "<li><a href=\"career.php?matchFormat=$matchFormat&disc=$disc\"><b>Best $matchFormat All-Round Careers</b></a>:<br/> This evaluates overall careers by calculating the average match all-round rating of each player, with a bonus given to career longevity and a penalty for careers of less than 40 matches (increasing penalty for lower matches played). An additional bonus is added based on the player's batting average - bowling average ratio. The 95% confidence interval range is shown with a &plusmn; after the career rating.</li><br/>";
