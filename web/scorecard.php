...
function inningsTable($db, $matchId, $innings, $bpo, $batInnNum, $target, $matchFormat) {
    ...
    if ($batInnNum == 1) {
        if ($matchFormat == "FT20") {
            ...
            echo "<th><a href=\"team.php?team=".$det[0]."&matchFormat=$matchFormat\"><img src=\"images/".$det[0].".png\" alt=\"".$det[0]."\" style='border:1px solid #A9A9A9'/></a>&nbsp; <b>".$det[0]." 1st Innings</b></th>";
        }
    } else {
	if ($innings == 4) {
	    echo "<th><a href=\"team.php?team=".$det[0]."&matchFormat=$matchFormat\"><img src=\"images/".$det[0].".png\" alt=\"".$det[0]."\" style='border:1px solid #A9A9A9'/></a>&nbsp; <b>".$det[0]." 2nd Innings</b> (Target: ".$target." runs)</th>";
	} else {
            if ($matchFormat == "FT20") {
                echo "<th><a href=\"team.php?team=".$det[0]."&matchFormat=$matchFormat\"><b>".$det[0]."</a> 2nd Innings</b></th>";
            } else {
                echo "<th><a href=\"team.php?team=".$det[0]."&matchFormat=$matchFormat\"><img src=\"images/".$det[0].".png\" alt=\"".$det[0]."\" style='border:1px solid #A9A9A9'/></a>&nbsp; <b>".$det[0]." 2nd Innings</b></th>";
            }
	}
    }
    echo "<th></th>";
	...
	for ($j = 0; $j < $result->numColumns(); $j++) {
		...
		echo "<td>".str_replace("ï¿½ï¿½","",$batInn[2])."</td>";
	    } elseif ($j == 3) { # runs
