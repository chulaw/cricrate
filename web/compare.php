...
if ($playerId2 == "" && $player2Search == "") {
   ...
   echo "</div>";
    echo "<br/><br/>";
    echo "<img src=\"images/".$country1.".png\" style='border:1px solid #A9A9A9'/>&nbsp;&nbsp;&nbsp;<a href=\"player.php?playerId=$playerId1\">".$player1."</a><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; vs <br/><br/>";
    echo "<div class=\"form-group\">";
   ...
   echo "<br/><br/>";
	...
	echo "<li><img src=\"images/".$res[2].".png\" style='border:1px solid #A9A9A9'/>&nbsp;&nbsp;&nbsp;<a href=\"compare.php?playerId1=$playerId1&playerId2=".$res[0]."&player2Search=$player2Search&matchFormat=$matchFormat&disc=$disc&inningsDate=$inningsDate\">".str_replace("Sir ","",$res[1])."</a></li>";
	...
	echo "<h2><b>".$player1."</b>&nbsp;&nbsp;<a href=\"team.php?team=".$country1."&matchFormat=$matchFormat\"><img src=\"images/".$country1.".png\" style='border:1px solid #A9A9A9'/></a>&nbsp; <b>vs ".$player2."</b>&nbsp;&nbsp;<a href=\"team.php?team=".$country2."&matchFormat=$matchFormat\"><img src=\"images/".$country2.".png\" style='border:1px solid #A9A9A9'/></a></h2>";
	$playerFound = 1;
    }
    ...
    echo "<td><b>".round($res2[9], 0)."</b> &plusmn; ".round($res2[10], 0)."</td>";
		...
		for ($j = 0; $j < $result->numColumns(); $j++) {
			...
			if ($matchFormat == "FT20") {
			    ...
			    if ($country1 == $res1[$j]) {
				$tableHtml .= "<td><a href=\"team.php?team=".$res1[$j+1]."&matchFormat=$matchFormat\"><img src=\"images/".$res1[$j+1].".png\" style='border:1px solid #A9A9A9'/></a></td>";
			    } else {
				$tableHtml .= "<td><a href=\"team.php?team=".$res1[$j]."&matchFormat=$matchFormat\"><img src=\"images/".$res1[$j].".png\" style='border:1px solid #A9A9A9'/></a></td>";
			    }
			}
			$j++;
		    } elseif ($j == 8) { # ground
		...
		for ($j = 0; $j < $result->numColumns(); $j++) {
			...
			if ($matchFormat == "FT20") {
			    ...
			    if ($country2 == $res2[$j]) {
				$tableHtml .= "<td><a href=\"team.php?team=".$res2[$j+1]."&matchFormat=$matchFormat\"><img src=\"images/".$res2[$j+1].".png\" style='border:1px solid #A9A9A9'/></a></td>";
			    } else {
				$tableHtml .= "<td><a href=\"team.php?team=".$res2[$j]."&matchFormat=$matchFormat\"><img src=\"images/".$res2[$j].".png\" style='border:1px solid #A9A9A9'/></a></td>";
			    }
			}
			$j++;
		    } elseif ($j == 8) { # ground
